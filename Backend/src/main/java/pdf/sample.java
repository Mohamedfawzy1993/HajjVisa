...
public class sample {
    ...
    public sample(String USER_FNAME, String USER_MNAME, String USER_LNAME,
           String PLACE_OF_BIRTH, String DATE_OF_BIRTH,
           String EMAIL, String PHONE_NO, String NATIONALITY,
           String PASSPORT_NO, String PASSPORT_ISSUE_DATE,
           String PASSPORT_EXPIRY_DATE, String PASSPORT_TYPE,
           String VISA_ID, String VISA_TYPE, String ISSUE_DATE,
           String VALIDITY, String ISSUE_OFFICE, String PURPOSE,
           String FEES, String NUMBER_OF_ENTRIES, String COMPANION,
           String WORK_PERMIT, String VISA_OFFICER, String STATUES,
                  String fileName) {
        text = USER_FNAME;
        text1 = USER_MNAME;
        text2 = USER_FNAME;
    ...
    public void create() {
        ...
        //Begin the Content stream
            System.out.println(new File("src/main/resources/img/x2030.png").toURI());
            PDImageXObject pdImage = PDImageXObject.createFromFile("src/main/resources/img/x2030.png", document);

        PDImageXObject pdImage4 = null;

            pdImage4 = PDImageXObject.createFromFile("src/main/resources/img/code128.gif", document);

        //PDImageXObject pdImage4 = PDImageXObject.createFromFile("C:\\Users\\hsr99\\Desktop\\hajj\\PdfBox_Examples\\TITLE.png",document);
        PDImageXObject pdImage2 = PDImageXObject.createFromFile("src/main/resources/img/logo.png", document);
        PDImageXObject pdImage3 = PDImageXObject.createFromFile("src/main/resources/img/tabel.png", document);
        ...
        contentStream.close();
        document.save("src/main/resources/img/"+fileName);
